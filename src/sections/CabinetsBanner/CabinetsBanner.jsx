import './CabinetsBanner.scss'
import Section from "@/layouts/Section";
import Slider from "@/components/Slider";
import SliderNavigation from "@/components/Slider/components/SliderNavigation";
import BannerCard from "@/components/BannerCard";

const CabinetsBanner = (props) => {
  const {
    className,
  } = props

  const titleId = 'cabinets-banner-title'
  ...
  const sliderNavigationId = 'cabinets-banner-slider-navigation'
  ...
  return (
    <Section
      className='cabinets-banner'
      titleId={titleId}
    >

      <h1 className="visually-hidden" id={titleId}>Cabinets</h1>
