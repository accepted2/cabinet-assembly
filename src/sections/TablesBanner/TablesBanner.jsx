import './TablesBanner.scss'
import Section from "@/layouts/Section";
import Slider from "@/components/Slider";
import SliderNavigation from "@/components/Slider/components/SliderNavigation";
import BannerCard from "@/components/BannerCard";

const TablesBanner = (props) => {
  const {
    className,
  } = props

  const titleId = 'tables-banner-title'
  ...
  const sliderNavigationId = 'tables-banner-slider-navigation'
  ...
  return (
    <Section
      className='tables-banner'
      titleId={titleId}
    >

      <h1 className="visually-hidden" id={titleId}>Tables</h1>
